...
from .export import  coords2dxf, feat2csv
...
TYPES = {
  ...
  "Комплексы":24,
  "Проекты ЗУ":15,
  "Земля для стройки":25,
  "Земля для туризма":27,
  "Объект туристского интереса":28,
  "Кварталы":2,
  "Районы":3,
  "Округа":4,
  "ЗОУИТ":10,
  "Зоны и территории":2,
  "Территориальные зоны":6,
  "Красные линии":13,
  "Границы":7,
  "Негативные процессы":23,
  "Усолье-Сибирское":26,
}
